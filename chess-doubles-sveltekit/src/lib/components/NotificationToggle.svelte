<script lang="ts">
	...
	import { enableNotifications, disableNotifications, getCurrentSubscription } from '$lib/notifications/client';

	let notificationStatus: 'enabled' | 'disabled' | 'loading' | 'unsupported' = 'loading';
...
<div class="notification-toggle">
	...
	<p class="description">
		...
		{:else}
			Get notified about game invites, moves, and friend requests.
		{/if}
	</p>
